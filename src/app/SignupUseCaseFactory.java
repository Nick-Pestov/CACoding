...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUseCase(clearUserDataAccessObject);
    ...
    private static ClearController createClearUseCase(ClearUserDataAccessInterface userDataAccessObject) throws IOException {
